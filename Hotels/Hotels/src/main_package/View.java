...
public class View extends JFrame implements Observer {
    ...
    public int setMove(Model model) {
    	...
    	int moveDest = JOptionPane.showOptionDialog(null, "Select a tile to go to.", "Set Move", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, null, possibleTiles, possibleTiles[0]) + model.getCurrentPlayer().getPosition();
    	return moveDest;
    }
